...
class _SearchState extends State<Search> {
  ...
  List _list = [];
  List ? _morefilerlist;
  List category = ["No Category Selected","AutoMobiles","Books and Learning","Computer and Pheripherals",
              ...
              Column(
                children: [
                  ...
                  Container(
                    width: 500,
                    height: 500,
                    child: (searchString == null || searchString == '' )?Padding(
  ...
  void searchProduct(String searchvalue ){
    if(_morefilerlist == null) {
      setState(() {
        List  list = widget.list.where((element) =>
      ...
      setState(() {
        ...
        _list = _morefilerlist!.where((element) =>
        (element["product_name"]!.toString()
            .toLowerCase().contains(searchvalue) )).toList();
        print(_list);
      });
  ...
  void searchmorelist( String catname){
    if(catname == "No Category Selected"){
      ...
      _morefilerlist = widget.list.where((element) =>
      (element["category_details"]["slug"]!.toString()
          .contains(catname))).toList();
