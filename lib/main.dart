...
import 'package:secondhandshop/Authentication/login.dart';
import 'package:secondhandshop/homePage/homescreen.dart';
import 'package:secondhandshop/homePage/itemcard.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     // body:  ProductCard(src: "https://images.pexels.com/photos/213780/pexels-photo-213780.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",),
      body: Center(
